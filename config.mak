...
# GCC 17 trunk (git snapshot injected as sources/gcc-17.0.0.tar.gz + patches/gcc-17.0.0)
GCC_VER = 17.0.0
# C only: toybox/kernel/musl are all C; skips libstdc++/target-libbacktrace
# (musl lacks struct elf32_fdpic_loadaddr, breaks libbacktrace FDPIC path).
